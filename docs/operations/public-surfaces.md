...
| Kromgo badges               | GitHub's image proxy and other fetchers                            | Cluster version and count metadata                                           | No                                                                         | Only pre-defined queries run, only the badge path is routed, and the label-bearing json format answers 404 externally (the shields format stays, for shields.io compatibility) |
