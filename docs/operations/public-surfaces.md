...
| Kromgo badges               | GitHub's image proxy and other fetchers                            | Cluster version and count metadata; its JSON format exposes additional labels | No                                                                         | Only pre-defined queries run, and only the badge path is routed         |
